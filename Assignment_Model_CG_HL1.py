...
def error_checking(calculated_outputs, data_outputs):
    ...
    Avg_error = np.sum(error)/len(data_outputs[0])
    # print("error_checking: Avg_error = ", Avg_error)
    # print("error_checking: len(data_outputs) = ", len(data_outputs[0]))
    # print("\n")
...
def de_E_function_HL1(calculated_outputs_Tr, activated_hidden1_outputs, W_out_new, data_inputs, data_outputs):
    ...
    # since prev_de_B_HL1 is the collection of outputs for all the samples, it's multiplying out(1-out) for every elements 
    # which is the deritivative of the sigmoid function
    prev_de_B_HL1 = np.array([[x*(1 - x) for x in sample] for sample in deepcopy(activated_hidden1_outputs)])
    # print("de_E_function_HL1: prev_de_B_HL1 DEBUG = ", prev_de_B_HL1)
    # print("de_E_function_HL1: prev_de_B_HL1.T DEBUG = ", prev_de_B_HL1.T)
    # print("\n")
    
    if (len(W_out_new) == 1):
        de_B_HL1 = np.multiply(prev_de_B_HL1, W_out_new)
        final_de_B_HL1 = np.multiply(de_B_HL1, Diff_Calc_Measure)
        SUM_de_B_HL1 = np.transpose([final_de_B_HL1.sum(axis=0)])
        # print("de_E_function_HL1: de_B_HL1 LENGTH 1 = ", de_B_HL1)
        # print("de_E_function_HL1: final_de_B_HL1 LENGTH 1 = ", final_de_B_HL1)
        # print("de_E_function_HL1: SUM_de_B_HL1 LENGTH 1 = ", SUM_de_B_HL1)
        # print("\n")
        
        prev_de_w_HL1 = np.multiply(de_B_HL1, data_inputs)
        de_w_HL1 = np.multiply(prev_de_w_HL1, Diff_Calc_Measure)
        SUM_de_w_HL1 = np.transpose([np.sum(de_w_HL1, axis = 0)])
        # print("de_E_function_HL1: prev_de_w_HL1 LENGTH 1 = ", prev_de_w_HL1)
        # print("de_E_function_HL1: de_w_HL1 LENGTH 1 = ", de_w_HL1)
        # print("de_E_function_HL1: SUM_de_w_HL1 LENGTH 1 = ", SUM_de_w_HL1)
        # print("\n")
    else:
        de_B_HL1 = np.dot(prev_de_B_HL1.T, W_out_new)
        final_de_B_HL1 = np.multiply(de_B_HL1, Diff_Calc_Measure)
        SUM_de_B_HL1 = final_de_B_HL1.sum(axis=0)
        # print("de_E_function_HL1: de_B_HL1 = ", de_B_HL1)
        # print("de_E_function_HL1: final_de_B_HL1 = ", final_de_B_HL1)
        # print("de_E_function_HL1: SUM_de_B_HL1 = ", SUM_de_B_HL1)
        # print("\n")
    ...
    de_w_HL1 = np.multiply(prev_de_w_HL1, Diff_Calc_Measure)
    SUM_de_w_HL1 = np.transpose([np.sum(de_w_HL1, axis = 0)])
    # print("delta_E_function_HL1: prev_de_w_HL1 = ", prev_de_w_HL1)
...
def Conjugate_Gradient_HL1(user_Validation_error, W_out, W_HL1, B_out, B_HL1, data_Tr_inputs, data_outputs_Tr, max_epoch):
    ...
    for epoch in range(max_epoch):
        ...
        calculated_outputs_Tr, activated_hidden1_outputs_Tr = feedforward_comp(W_out_new[0], W_HL1_new[0], B_out_new[0], B_HL1_new[0], data_Tr_inputs)
        ...
        SUM_de_w_out, SUM_de_w_HL1, SUM_de_B_out, SUM_de_B_HL1 = de_E_function_HL1(calculated_outputs_Tr, activated_hidden1_outputs_Tr,
                                                                                   W_out_new[0], data_Tr_inputs, data_outputs_Tr)
        ...
        if (epoch == 0):
            ...
            # print("Conjugate_Gradient_HL1 (epoch = ",epoch,"): h_W_out_epoch0 = ", h_W_out_epoch0)
            # print("Conjugate_Gradient_HL1 (epoch = ",epoch,"): h_W_hidden_epoch0 = ", h_W_hidden_epoch0)
            # print("Conjugate_Gradient_HL1 (epoch = ",epoch,"): h_B_out_epoch0 = ", h_B_out_epoch0)
            # print("Conjugate_Gradient_HL1 (epoch = ",epoch,"): h_B_hidden_epoch0 = ", h_B_hidden_epoch0)
            # print("\n")
            ...
            etah = line_search_function_h_hidden(W_out_new_epoch0, W_HL1_new_epoch0, B_out_new_epoch0, B_HL1_new_epoch0,
                                                 ...
                                                 data_Tr_inputs, data_outputs_Tr)
            ...
            # print("Conjugate_Gradient_HL1 (epoch = ",epoch,"): np.multiply(h_W_out_epoch0,etah) = ", np.multiply(h_W_out_epoch0,etah))
            # print("Conjugate_Gradient_HL1 (epoch = ",epoch,"): np.multiply(h_W_hidden_epoch0,etah) = ", np.multiply(h_W_hidden_epoch0,etah))
            # print("Conjugate_Gradient_HL1 (epoch = ",epoch,"): np.multiply(h_B_out_epoch0,etah) = ", np.multiply(h_B_out_epoch0,etah))
            # print("Conjugate_Gradient_HL1 (epoch = ",epoch,"): np.multiply(h_B_hidden_epoch0,etah) = ", np.multiply(h_B_hidden_epoch0,etah))
            # print("\n")
            ...
            # print("Conjugate_Gradient_HL1 (epoch = ",epoch,"): h_W_out PREV = ", h_W_out)
            # print("Conjugate_Gradient_HL1 (epoch = ",epoch,"): h_W_hidden PREV = ", h_W_hidden)
            # print("Conjugate_Gradient_HL1 (epoch = ",epoch,"): h_B_out PREV = ", h_B_out)
            # print("Conjugate_Gradient_HL1 (epoch = ",epoch,"): h_B_hidden PREV = ", h_B_hidden)
            # print("\n")
            ...
            final_delta_B_W_out = np.add(delta_B_W_out, SUM_de_B_out)
            final_delta_B_W_hidden = np.add(delta_B_W_hidden, SUM_de_B_HL1)
            ...
            # print("Conjugate_Gradient_HL1 (epoch = ",epoch,"): final_delta_B_W_out = ", final_delta_B_W_out)
            # print("Conjugate_Gradient_HL1 (epoch = ",epoch,"): final_delta_B_W_hidden = ", final_delta_B_W_hidden)
            # print("\n")
            ...
            # W = W + delta_W
            W_out_final = np.add(W_out_new[0], np.multiply(h_W_out[0], etah))
            W_hidden_final = np.add(W_HL1_new[0], np.multiply(h_W_hidden[0], etah))
            B_out_final = np.add(B_out_new[0], np.multiply(h_B_out[0], etah))
            B_hidden_final  = np.add(B_HL1_new[0], np.multiply(h_B_hidden[0], etah))
...
if (Ali_num_HL == 1):
    ...
    [W_out_new, W_HL1_new, B_out_new, B_HL1_new, num_epoch_iter, Training_error_collection] = Conjugate_Gradient_HL1(user_Validation_error,
                                                                                                                                  ...
                                                                                                                                  data_Tr_inputs, data_Tr_outputs,
                                                                                                                                  max_epoch)
