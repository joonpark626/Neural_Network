...
def de_E_function_HL1(W_out_new, W_HL1_new, B_out_new, B_HL1_new, calculated_outputs_Tr, activated_hidden1_outputs, data_inputs, data_outputs):
    ...
    prev_de_B_HL1 = np.array([[x*(1 - x) for x in sample] for sample in deepcopy(activated_hidden1_outputs)])
    ...
    # else:
    #     delta_B_HL1_computation(prev_de_B_HL1, data_inputs):
...
with open('Debug_data.csv', newline='') as f:
    reader = csv.reader(f)
    data_Tr = list(reader)
data_Tr.pop(0)
