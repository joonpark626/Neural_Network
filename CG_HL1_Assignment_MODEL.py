...
def de_E_function_HL1(calculated_outputs_Tr, activated_hidden1_outputs, data_inputs, data_outputs):
    ...
    prev_de_B_HL1 = np.array([[pow(x,2)*(1 - x) for x in sample] for sample in activated_hidden1_outputs])
    de_B_HL1 = np.multiply(prev_de_B_HL1, Diff_Calc_Measure)
    ...
    prev_de_w_HL1 = np.multiply(prev_de_B_HL1, data_inputs)
