...
def Jacobian_Matrix_finder(W_out_new, W_HL1_new, B_out_new, B_HL1_new, activated_hidden1_outputs, data_inputs, Tr_errors):
    ...
    # print("Jacobian_Matrix_finder: Tr_errors = ", Tr_errors)
    # print("\n")
...
def Levenberg_Marquardt_HL1(user_Validation_error, W_out, W_HL1, B_out, B_HL1, Tr_data_inputs, Tr_data_outputs, mui, max_epoch):
    ...
    for epoch in range(max_epoch):
        ...
        Jacobian_Matrix = Jacobian_Matrix_finder(W_out_new, W_HL1_new, B_out_new, B_HL1_new, activated_hidden1_outputs, Tr_data_inputs, Tr_errors)
